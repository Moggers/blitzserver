...
impl GameLog {
    ...
    {
        diesel::sql_query(
            r#"UPDATE game_logs SET output = CONCAT(output, $1) AND error = CONAT(error, $2) WHERE id=$3"#,
        )
        .bind::<diesel::sql_types::VarChar,_>(logs_output)
        .bind::<diesel::sql_types::VarChar,_>(logs_err)
